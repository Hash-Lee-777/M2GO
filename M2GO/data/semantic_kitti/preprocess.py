...
from M2GO.data.semantic_kitti import splits
...
class DummyDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # debug
        # from M2GO.data.utils.visualize import draw_points_image, draw_bird_eye_view
...
if __name__ == '__main__':
    root_dir = '/work/sdim-lemons/jjch/3D_Openset_UDA/data/SemanticKITTI'
    out_dir = '/work/sdim-lemons/jjch/3D_Openset_UDA/data/SemanticKITTI_preprocess'
