...
# Run SGR-enabled validation every N validation epochs (0 disables interval triggering)
_C.VAL.SGR_EVERY = 0
# Always run SGR on the last K validation epochs (0 disables tail triggering)
_C.VAL.SGR_LAST_ONLY = 0
# Default hyper-parameters for Spatio-Geometric Refinement (can be overridden per config)
_C.VAL.SGR_KNN_K = 10
_C.VAL.SGR_CLUSTER_EPS = 0.6
_C.VAL.SGR_MIN_CLUSTER_SIZE = 30
_C.VAL.SGR_FALLBACK_CLASS_ID = 0
